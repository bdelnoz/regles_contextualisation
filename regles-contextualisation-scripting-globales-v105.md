Regle de scripting V105

supprime les regles precedentes et applique ca !

13. CONSIGNES GENERALES **SCRIPTING ET GENERATION DE CODE**
...
14.8.4 Tout script fourni doit respecter le mode simulate comme suit :
...
14.14.1 Après chaque script, expliquer chaque étape en texte clair dans la consolme et toujours aussi dans le code
...
14.21. Ne pas demander de confirmation avant de donner une nouvelle version, donner directement tout le script complet !


14.22. reduction des tokens, il faut reduire le nombre de token lors de la generation des scripts 
